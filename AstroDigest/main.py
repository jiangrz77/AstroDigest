...
def main():
    ...
    staging_dir = (
        os.environ.get("ASTRODIGEST_OUTPUT_STAGING_DIR", "").strip()
        or os.environ.get("APD_OUTPUT_STAGING_DIR", "").strip()
    )
