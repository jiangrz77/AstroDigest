#!/bin/bash
# Fix + rebuild the native Astro Digest.app after source changes.
#
...
#   2. regenerates the root native Astro Digest.app
#
...
echo "==> 2/2 Regenerating Astro Digest.app (workspace root) ..."
./build_app.sh

echo ""
echo "Done. Now open:"
echo "  $(cd .. && pwd)/Astro Digest.app"
echo ""
